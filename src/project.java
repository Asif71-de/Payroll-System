...
//		t3.setFont(new Font("monospaced", Font.PLAIN, 12));
//		t3.setMnemonic('S');
//		t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/schedreport.pmg")));
//		t3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
//		
//		JMenuItem t4 = new JMenuItem("List Employee");
//		
...
//		s2.setMnemonic('p');
//		s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/empreport.png")));
//		s2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, ActionEvent.CTRL_MASK));
//		
//		edit.add(s2);
//		
...
//		s3.setFont(new Font("monospaced", Font.PLAIN, 12));
//		s3.setMnemonic('U');
//		s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/EXPENSES.png")));
//		s3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, ActionEvent.CTRL_MASK));
//		
//		edit.add(s3);
//		
//		s1.addActionListener(this);
...
//		p1.setMnemonic('P');
//		p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/payments.png")));
//		p1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, ActionEvent.CTRL_MASK));
//		
//		
//		rep.add(p1);
...
//		p2.setMnemonic('L');
//		p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/empreport.png")));
//		p2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, ActionEvent.CTRL_MASK));
//	  	
//		rep.add(p2);
//		p1.addActionListener(this);
//		p2.addActionListener(this);
//		
//		JMenuItem util = new JMenuItem("Utilities");
...
//		
//		if(msg.equals("New Employee"))
//			new New_Emplyee().setVisible(true);
//		else if(msg.equals("List Employee"))
//			new List_Employee().setVisible(true);
//		else if(msg.equals("Update Employee"))
//			new Update_employee().setVisible(true);
